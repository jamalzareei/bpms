                        ...
                        <div class="card card-revenue-budget">
                            <div class="row mx-0">
                                    ...
                                    <div class="d-sm-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="d-flex align-items-center mr-2">
                                                <span
                                                    class="bullet bullet-info font-small-3 mr-50 cursor-pointer"></span>
                                                <span>Earning</span>
                                            </div>
                                ...
                                <div class="col-md-4 col-12 budget-wrapper">
                                    <div class="btn-group">
                                        <button type="button"
                                            class="btn btn-outline-info btn-sm dropdown-toggle budget-dropdown"
                                    ...
                                    <button type="button" class="btn btn-info">Increase Budget</button>
                                </div>
                            </div>
                        </div>
                    </div>
