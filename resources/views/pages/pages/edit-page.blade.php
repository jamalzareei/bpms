                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12">
                                ...
                                <input type="checkbox" class="custom-control-input" 
                                    name="actived_at" id="actived_at" {{($page->actived_at) ? 'checked' : ''}}>
                                    
                                <span class="custom-control- custom-switch  custom-switch-success mr-2 mb-1">
                                    <input type="checkbox" class="custom-control-input" name="actived_at" id="checkbox{{$page->id}}" {{ $page->actived_at ? 'checked' : ''}}>
