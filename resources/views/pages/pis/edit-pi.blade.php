                                ...
                                <div class="form-group">
                                    ...
                                    <select name="factory_id" class="form-control" id="factory_id" >
                                        ...
                                        @forelse ($factories as $factory)
                                            <option value="{{$factory->id}}" {{($pi->factory_id == $factory->id) ? 'selected' : ''}}>{{$factory->name}}</option>
                                        @empty
...
{{-- 
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="issud_at"   class="form-control selector" placeholder="PI Issued" name="issud_at" value="{{$pi->issud_at}}" />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="producing" class="form-control" placeholder="Producing Item " name="producing" value="{{$pi->producing}}" />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="trucks_on_border" class="form-control" placeholder="Trucks on the border/port" name="trucks_on_border" value="{{$pi->trucks_on_border}}" />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="trucks_vend_on_way" class="form-control" placeholder="Trucks on vend on the way" name="trucks_vend_on_way" value="{{$pi->trucks_vend_on_way}}" />
